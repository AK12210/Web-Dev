  ...
  template: `
    ...
    <div class="album-list">
      <mat-card *ngFor="let album of albums" class="album-card">
        ...
        <mat-card-actions>
          <button mat-button (click)="viewDetails(album.id)">View Details</button>
          <button mat-button (click)="viewPhotos(album.id)">Photos</button>
          <button mat-button (click)="deleteAlbum(album.id)">Delete</button>
        </mat-card-actions>
      </mat-card>
    </div>
  `,
